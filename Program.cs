...
namespace Lesson8
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"\nLast element: {0}", ArrayHelper.Pop(ref arr));
            ...
            Console.WriteLine("New Array Lenght: {0}", ArrayHelper.Push(ref arr, ne));
            System.Console.WriteLine("\n");


            Console.WriteLine("New Array:");
            foreach (string s in arr) { Console.Write(s + " "); }
            Console.WriteLine($"\nLast Element: {0}", ArrayHelper.Shift(ref arr));
            Console.WriteLine("New Array:");
            foreach (string s in arr) { Console.Write(s + " "); }
            System.Console.WriteLine("\n");
            ...
            Console.WriteLine("New Array Lenght: {0}", ArrayHelper.UnShift(ref arr, ne));
        }
